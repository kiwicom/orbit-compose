...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(MainDestinations.KEY_VALUE) {
            KeyValueScreen(actions::navigateUp)
        }
        ...
        composable(MainDestinations.LOADING) {
            LoadingScreen(actions::navigateUp)
        }
...
class MainActions(
    ...
    fun showKeyValue() {
        navController.navigate(MainDestinations.KEY_VALUE)
    }
    ...
    fun showListChoice() {
        navController.navigate(MainDestinations.LIST_CHOICE)
    }
