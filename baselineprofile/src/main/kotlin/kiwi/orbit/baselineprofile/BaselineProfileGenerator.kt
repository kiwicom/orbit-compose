...
internal class BaselineProfileGenerator {
    ...
    @Test
    fun generate1StartupProfile() {
        // This test generates both the startup and baseline profiles. Because we want to generate the baseline profile
        // from a larger part of the application, we need to make sure this test runs before the test generating the
        // complete baseline profile and thus overrides the incomplete baseline profile generated by this test.
